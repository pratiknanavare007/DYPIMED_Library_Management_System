...
<html lang="en">
    <head>
        ...
        <title>DYPIMED LMS | DYPIMED Library Management System</title>
        ...
        <!-- Favicons -->
        <link rel="icon" type="image/x-icon" href="asset/images/BVPDU.png">
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <a class="navbar-brand ps-3" href="index.php">DYPIMED Library</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div>
        			    ...
        			    <div>
                            <a href="index.php" class="d-flex align-items-center text-dark text-decoration-none">
                                <span class="fs-4" style= "width: 90%">Dr. D. Y. Patil Institute of Management and Entrepreneur Development</span>
                            </a>
                        </div>
                        <div class="nav1">
